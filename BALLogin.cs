...
namespace Business_logic_Layer
{
    public class BALLogin
    {
        ...
        public ResponseResult LoginUser(Data_Access_Layer.Repository.Entities.LoginRequest loginRequest)
        {
            try
            {
        ...
        public User UserLogin(Data_Access_Layer.Repository.Entities.LoginRequest loginRequest)
        {
